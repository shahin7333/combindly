...
import { ArrowRight, CircleCheck, Plane, Zap } from "lucide-react";
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-4 lg:px-16">
      <div className="mt-6 flex flex-col items-center">
        <Button
          variant="secondary"
          className="shadow font-light bg-[#13C9CD] bg-opacity-15 text-xs dark:shadow-gray-700 border border-secondary hover:bg-opacity-25 rounded-lg mx-auto text-center max-w-max px-1.5 py-1 h-8"
        >
          <p className="px-1 py-0.5 bg-secondary rounded-sm font-semibold mr-2 text-white">
            New
          </p>{" "}
          Combindly V2 is now available!{" "}
      ...
      <h1 className="mt-10 text-3xl md:text-[92px] text-center mx-auto font-medium md:max-w-[95%] lg:leading-[90px]">
      ...
      <div className="mt-10 flex justify-center items-center gap-6 flex-wrap">
        ...
        >
          <CircleCheck className="h-4 w-4 mr-2 text-secondary" /> Free 7-Days
          trial
        </Button>
        <Button
          variant="ghost"
          className="shadow dark:shadow-gray-700 md:text-base"
        >
          <CircleCheck className="h-4 w-4 mr-2 text-secondary" /> Built
        ...
        <Button
          ...
          className="shadow dark:shadow-gray-700 md:text-base"
        >
          <CircleCheck className="h-4 w-4 mr-2 text-secondary" /> 24/7 Live
          Support
        </Button>
      </div>
    </div>
