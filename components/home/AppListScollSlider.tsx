...
const HorizontalScrollCarousel = () => {
    ...
    return (
        <section ref={targetRef} className="relative h-[300vh] mt-20 lg:mt-40">
    ...
    return (
        ...
        >
            ...
            <motion.div className="flex flex-col gap-4">
                <p className="text-6xl bg-clip-text text-transparent bg-gradient-to-r from-[#2856cb]  via-[#F56028] to-[#FAA22B] font-bold max-w-[400px] break-words hyphens-auto">
                    {card.label}
                </p>
